...
public class Account {
    ...
    public String getUsername_of_account_holder() { return username_of_account_holder; }
    public void setUsername_of_account_holder(String username_of_account_holder) { this.username_of_account_holder = username_of_account_holder; }
    ...
    public Date getAccount_opening_date() { return account_opening_date; }
    public void setAccount_opening_date(Date account_opening_date) { this.account_opening_date = account_opening_date; }

    @Override
    public String toString() {
        String d = (account_opening_date == null)
                ? "null"
                : new SimpleDateFormat("dd/MM/yyyy").format(account_opening_date);

        return String.format("%-10s| %-30s| %-10s| %-15s",
                account_number, username_of_account_holder, account_type, d);
    }
}
